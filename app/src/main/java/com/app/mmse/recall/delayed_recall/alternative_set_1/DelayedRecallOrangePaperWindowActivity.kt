package com.app.mmse.recall.delayed_recall.alternative_set_1
...
import kotlinx.android.synthetic.main.activity_delayed_recall_orange_paper_window.*

class DelayedRecallOrangePaperWindowActivity : AppCompatActivity(), RecognitionListener {
    ...
    override fun onResults(results: Bundle) {
        ...
        delayed_recall_orange_paper_window_vr_txtview?.text = matches!![0]
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_delayed_recall_orange_paper_window)
    ...
    override fun onError(errorCode: Int) {
        ...
        delayed_recall_orange_paper_window_vr_txtview?.text = errorMessage
    }
    ...
    private fun createViews() {
        scoreTxtFinal = findViewById(R.id.delayed_recall_orange_paper_window_score_txt_final)
        readyButton = findViewById(R.id.delayed_recall_orange_paper_window_ready_btn)
        goBackButton = findViewById(R.id.delayed_recall_orange_paper_window_go_back_btn)
        doneButton = findViewById(R.id.delayed_recall_orange_paper_window_done_btn)
    }
