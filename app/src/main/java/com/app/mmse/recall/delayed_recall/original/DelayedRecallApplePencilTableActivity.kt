package com.app.mmse.recall.delayed_recall.original
...
import kotlinx.android.synthetic.main.activity_delayed_recall_apple_pencil_table.*

class DelayedRecallApplePencilTableActivity : AppCompatActivity(), RecognitionListener {
    ...
    override fun onResults(results: Bundle) {
        ...
        delayed_recall_apple_pencil_table_vr_txtview?.text = matches!![0]
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_delayed_recall_apple_pencil_table)
    ...
    override fun onError(errorCode: Int) {
        ...
        delayed_recall_apple_pencil_table_vr_txtview?.text = errorMessage
    }
    ...
    private fun createViews() {
        scoreTxtFinal = findViewById(R.id.delayed_recall_apple_pencil_table_score_txt_final)
        readyButton = findViewById(R.id.delayed_recall_apple_pencil_table_ready_btn)
        goBackButton = findViewById(R.id.delayed_recall_apple_pencil_table_go_back_btn)
        doneButton = findViewById(R.id.delayed_recall_apple_pencil_table_done_btn)
    }
