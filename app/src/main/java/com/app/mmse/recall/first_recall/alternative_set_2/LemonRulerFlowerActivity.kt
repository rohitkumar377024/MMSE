package com.app.mmse.recall.first_recall.alternative_set_2
...
import kotlinx.android.synthetic.main.activity_lemon_ruler_flower.*

class LemonRulerFlowerActivity : AppCompatActivity(), RecognitionListener {
    ...
    override fun onResults(results: Bundle) {
        ...
        lemon_ruler_flower_vr_txtview?.text = matches!![0]
//        if (matches[0] != null) { //todo -> later on, check with all matches -- not just matches[0]
//            //todo -> scoring system needs to be setup here because this is where all the matches are retrieved
//            FirstRecallScoringSystem().setupScoringSystem(matches[0], scoreTxtFinal,
//                "lemon", "ruler", "flower")
//        }
        ...
        if (matches[0] != null) {
            ...
            if (TrialsCounter.trials <= 2 && !scoreOf3) {
                ...
                finish()
                IntentUtils().goToLemonRulerFlowerActivity(this)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_lemon_ruler_flower)

        //Calling functions from onCreate()
        createViews()
        createSpeechRecogniser()
        playLemonRulerFlowerActivity(R.raw.word_repeat_instruction, R.raw.ready_to_continue,
            R.raw.numeric_press_done_when_you_are_done, R.raw.lemon_ruler_flower, R.raw.beep)
    }
    ...
    override fun onError(errorCode: Int) {
        ...
        lemon_ruler_flower_vr_txtview?.text = errorMessage
    }
    ...
    private fun createViews() {
        scoreTxtFinal = findViewById(R.id.lemon_ruler_flower_score_txt_final)
        readyButton = findViewById(R.id.lemon_ruler_flower_ready_btn)
        goBackButton = findViewById(R.id.lemon_ruler_flower_go_back_btn)
        doneButton = findViewById(R.id.lemon_ruler_flower_done_btn)
    }
    ...
    private fun playLemonRulerFlowerActivity(audio_1: Int, audio2: Int, audio3: Int, audio4: Int, audio5: Int) {
            ...
            Handler().postDelayed({
                ...
                Handler().postDelayed({
                    ...
                    goBackButton.setOnClickListener {
                        ...
                        playLemonRulerFlowerActivity(R.raw.word_repeat_instruction, R.raw.ready_to_continue,
                            R.raw.ready_again_when_done, R.raw.lemon_ruler_flower, R.raw.beep)
                    }

                    //When Ready Button clicked -> play 3 words [apple, pencil, table] and start Voice Recognition
                    readyButton.setOnClickListener {
                        //play 3 words [apple, pencil, table] //todo AUDIO INFO -> "LEMON RULER FLOWER"
